...
<head>
    ...
    <title><?php echo $str['food_nonactivate'];?></title>
</head>
<body>
<table border="1" class="table_admin" width="100%">
    <tr><td colspan="2"><h1><?php echo $str['food_nonactivate']; ?></h1></td></tr>
    ...
    <?php require("template/site/ActiveFoodMenu.php");?>
        </td></tr>
