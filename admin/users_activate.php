...
$user = new User();
$result = $user->ActivateOrDeactivateUsersAdmin(true);
$set = new Settings();
?>
<!DOCTYPE html>
<html lang="fa">
<head>
    ...
    <title><?php echo $str['activate_user'];?></title>
</head>
<body>
<table border="1" class="table_admin" width="100%">
    <tr><td colspan="2"><h1><?php echo $str['activate_user']; ?></h1></td></tr>
    <tr><td width="20%"><a href="#"><?php echo $str['welcome'].$str['comma'].$_COOKIE['admin_username'];?></a></td><td rowspan="9" style="text-align: center;text-align-all: center;text-valign:middle;" width="80%">
            <?php require("template/site/ActiveUsersMenu.php");?>
        </td></tr>
