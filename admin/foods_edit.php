...
<head>
    ...
    <title><?php echo $str['food_edit'];?></title>
</head>
<body>
<table border="1" class="table_admin" width="100%">
    <tr><td colspan="2"><h1><?php echo $str['food_edit']; ?></h1></td></tr>
    ...
    <?php require("template/site/EditFoodMenu.php");?>
        </td></tr>
