...
<head>
    ...
    <title><?php echo $str['view_category'];?></title>
</head>
<body>
<table border="1" class="table_admin" width="100%">
    <tr><td colspan="2"><h1><?php echo $str['view_category']; ?></h1></td></tr>
    ...
    <?php require("template/site/ViewCetegoryMenu.php");?>
        </td></tr>
