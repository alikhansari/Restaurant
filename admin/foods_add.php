...
$cat = new Category();
$r_cat = $cat->CategoryList ();
$food = new Food();
$result = $food->AddFoodAdmin();
$set = new Settings();
?>
<!DOCTYPE html>
<html lang="fa">
<head>
    ...
    <title><?php echo $str['add_food'];?></title>
</head>
<body>
<table border="1" class="table_admin" width="100%">
    <tr><td colspan="2"><h1><?php echo $str['add_food']; ?></h1></td></tr>
    ...
    <?php require("template/site/AddFoodMenu.php");?>
        </td></tr>
    ...
    <tr><td width="20%"><a href="foods_add.php"><?php echo $str['food_manage'];?></a></td></tr>
