...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#results" ).load( "template/site/AllCompletedOrders.php"); //load initial records
            ...
            $("#results").on( "click", ".pagination a", function (e){
                ...
                $("#results").load("template/site/AllCompletedOrders.php",{"page":page}, function(){ //get content from PHP page
    ...
    <title><?php echo $str['completed_order'];?></title>
</head>
<body>
<table border="1" class="table_admin" width="100%">
    <tr><td colspan="2"><h1><?php echo $str['completed_order']; ?></h1></td></tr>
