...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#results" ).load( "template/site/AllRefundOrders.php"); //load initial records
            ...
            $("#results").on( "click", ".pagination a", function (e){
                ...
                $("#results").load("template/site/AllRefundOrders.php",{"page":page}, function(){ //get content from PHP page
    ...
    <title><?php echo $str['orders_refund'];?></title>
</head>
<body>
<table border="1" class="table_admin" width="100%">
    <tr><td colspan="2"><h1><?php echo $str['orders_refund']; ?></h1></td></tr>
